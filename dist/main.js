...
var $author$project$Main$typeCommand = function (model) {
	return $elm$core$String$isEmpty(model.command) ? _Utils_update(
		model,
		{typing: false}) : _Utils_update(
		model,
		{
			command: A2($elm$core$String$dropLeft, 1, model.command),
			title_text: _Utils_ap(
				model.title_text,
				A2($elm$core$String$left, 1, model.command))
		});
};
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'TypeCommand':
				return _Utils_Tuple2(
					$author$project$Main$typeCommand(model),
					A2(
						$elm$random$Random$generate,
						$author$project$Main$DelayTypeCommand,
						A2($elm$random$Random$int, 100, 1000)));
			case 'StopTyping':
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var $lattyware$elm_fontawesome$FontAwesome$Solid$Definitions$envelope = A4(
	...
	_Utils_Tuple2('M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z', $elm$core$Maybe$Nothing));
...
var $author$project$Main$linkIcon = function (link) {
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('shrink  md:text-4xl text-[7vw] p-[.8em] md:p-[1em]'),
				$elm$html$Html$Attributes$class('text-catppuccin-latte-overlay dark:text-catppuccin-mocha-overlay dark:hover:text-catppuccin-mocha-subtext hover:text-catppuccin-latte-subtext'),
...
var $author$project$Main$linkIcons = function () {
	...
	return A2(
		...
		A2($elm$core$List$map, $author$project$Main$linkIcon, links));
}();
...
var $author$project$Main$promptTopParts = function (time) {
	return _List_fromArray(
		[
			A2($author$project$Main$StyledText, time, 'text-catppuccin-latte-green dark:text-catppuccin-mocha-green pr-4'),
			A2($author$project$Main$StyledText, '-', 'text-catppuccin-latte-peach dark:text-catppuccin-mocha-peach pr-4'),
			A2($author$project$Main$StyledText, 'sonnen', 'text-catppuccin-latte-maroon dark:text-catppuccin-mocha-maroon'),
			A2($author$project$Main$StyledText, '@onnen.dev', 'text-catppuccin-latte-sapphire dark:text-catppuccin-mocha-sapphire pr-4'),
			A2($author$project$Main$StyledText, '[', 'text-catppuccin-latte-sapphire dark:text-catppuccin-mocha-sapphire'),
			A2($author$project$Main$StyledText, '~', 'text-catppuccin-latte-subtext dark:text-catppuccin-mocha-subtext'),
			A2($author$project$Main$StyledText, ']', 'text-catppuccin-latte-sapphire dark:text-catppuccin-mocha-sapphire')
		]);
};
var $author$project$Main$promptTopRow = function (parts) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$titleFontStyle = 'flex font-mono select-none md:text-8xl text-[14vw]';
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class($author$project$Main$titleFontStyle),
						$elm$html$Html$Attributes$class('dark:text-catppuccin-mocha-muave text-catppuccin-latte-muave pr-6 font-bold')
					]),
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class($author$project$Main$titleFontStyle),
						$elm$html$Html$Attributes$class('dark:text-catppuccin-mocha-text text-catppuccin-latte-text')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(model.title_text)
					])),
				A2(
				$elm$html$Html$h1,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class($author$project$Main$titleFontStyle),
						$elm$html$Html$Attributes$class('dark:text-catppuccin-mocha-overlay text-catppuccin-latte-overlay flex'),
...
var $author$project$Main$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex flex-col min-h-screen dark:bg-catppuccin-mocha-mantle bg-catppuccin-latte-mantle p-2 leading-tight')
			]),
		_List_fromArray(
			[
				$lattyware$elm_fontawesome$FontAwesome$Styles$css,
				$author$project$Main$promptTopRow(
				$author$project$Main$promptTopParts(time)),
				A2($elm$html$Html$Lazy$lazy, $author$project$Main$title, model),
				$author$project$Main$linkIcons
			]));
};
